...
name_cube_halfmax = 'pv_mask_imfit_c18o_pix_2_Tmb_trans_shift_halfmax.fits'
...
totalveldiff = np.concatenate((coreveldiffysoyes,coreveldiffysono))
totaloffset = np.concatenate((offsetysoyesarr,offsetysonoarr))
